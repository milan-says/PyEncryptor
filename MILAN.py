...
def logo():
    ...
    print("\033[94m│    \033[92m    __  _________    ___    _   __ \033[94m       │".center(column1))
    print("\033[94m│    \033[92m   /  |/  /  _/ /   /   |  / | / /\033[94m   │".center(column1))
    print("\033[94m│    \033[92m  / /|_/ // // /   / /| | /  |/ / \033[94m   │".center(column1))
    print("\033[94m│    \033[92m / /  / // // /___/ ___ |/ /|  /  \033[94m   │".center(column1))
    print("\033[94m│    \033[92m/_/  /_/___/_____/_/  |_/_/ |_/   \033[94m   │".center(column1))
    print("\033[94m│                                        │".center(column2))
    print("\033[94m│ \033[95mAuthor : Milan Bhandari Inc.           \033[94m│".center(column1))
    print("\033[94m│ \033[95mTool   : Encode Python2 and Python3    \033[94m│".center(column1))
    print("\033[94m│ \033[95mGitHub : https://github.com/Milan-Says \033[94m│".center(column1))
    print("\033[94m│ \033[95mCoder  : Milan Bhandari              \033[37mV3.0 \033[94m│".center(column3))
    print("\033[94m└────────────────────────────────────────┘".center(column2))
...
def logout():
    ...
    print("\033[93m[ \033[92mhttps://github.com/Milan-Says/ \033[93m]\033[37m\n".center(column3))
    sys.exit()
...
marshalHead = "# Encoded By PyEncryptor\n# A Product Of MilanBhandari\n# https://github.com/Milan-Says\n\nimport marshal\nexec(marshal.loads("
...
def encodeMarshal(data, power):
    ...
    for i in range(power):
        code = compile(powerData, "MilanBhandari", "exec")
...
def update():
    ...
    try:
        ...
        toolVersion = "MilanBhandari"
    try:
        mainVersion = requests.get("https://raw.githubusercontent.com/milan-says/PyEncryptor/main/.version").text
    except:
    ...
    if (toolVersion == mainVersion):
        ...
        os.system("cd .. && rm -rf PyEncryptor && git clone https://github.com/milan-says/PyEncryptor > /dev/null 2>&1")
        ...
        time.sleep(1)
        os.system("cd .. && cd PyEncryptor && python MILAN.py")
